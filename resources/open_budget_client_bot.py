...
async def adm_select_tariff(cb: CallbackQuery):
    ...
    kb_invoice = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text="🔙 Admin panelga qaytish", callback_data="adm_back", style="primary")]
    ])
...
async def vote_sms(msg: Message, state: FSMContext):
    ...
    # MVC/register flow da ovoz verify paytida beriladi, cast-vote kerak emas
