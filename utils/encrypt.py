...
def _get_fernet_key() -> bytes:
    """Derive a valid url-safe base64 32-byte Fernet key from the BOT_TOKEN"""
    # Hash the bot token to get exactly 32 bytes
    token_hash = hashlib.sha256(settings.BOT_TOKEN.encode()).digest()
